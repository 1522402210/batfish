...
public class NewNormalizerTest {
    ...
    private NewNormalizer _normalizer;
    ...
    public void setup() {
        ...
        _toBDD = new AclLineMatchExprToBDD(pkt.getFactory(), pkt, ImmutableMap.of(), ImmutableMap.of(), mgr);
    }

    private AclLineMatchExpr normalize(AclLineMatchExpr expr) {
        _normalizer = new NewNormalizer(_toBDD);
